        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                ...
                <div class="card-block">
                    ...
                    {{ Form::model($repositorio, ['id'=>'form', 'route'=>['repository.update',$repositorio->id], 'method'=>'PUT', 'files'=>true,'class'=>'js-validation-bootstrap form-horizontal']) }}
                        
                            <div class="form-group">
                                <label class="col-md-4 control-label" for="archivo">Nombre del documento: <span class="text-orange">*</span></label>
                                <div class="col-md-7">
                                    <input class="form-control" type="text" id="archivo" name="archivo" placeholder="Ingresa el nombre del archivo." value='{{ $repositorio->archivo }}'/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <input class="form-control" type="text" id="descripcion" name="descripcion" placeholder="Ingresa una reseña del contenido del archivo." value='{{ $repositorio->descripcion }}'/>
                                </div>
                            </div>
                        ...
                        <form id="formDelete" action="/repository/{{ $repositorio->id }}" method="POST">
