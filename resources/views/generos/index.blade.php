            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="form-group">
                        <div class="col-md-1">
                            <a id="btnNuevo" class="btn btn-default" href="/generos/create">Nuevo</a>
                        </div>
                        ...
                        <table class="table table-condensed">
                            ...
                            <tbody>
                                ...
                                <tr>                                    
                                    <td>{{ $genero->genero }}</td>
                                    <td>
                                        {{link_to_route("generos.edit", $title="Editar", $parameters=$genero->id, $attributes=['class'=>'btn btn-primary btn-xs'])}}                              
                                    </td>
                                </tr>
