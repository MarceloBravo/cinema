                    ...
                    {{ Form::model($pelicula,['id'=>'form', 'route'=>['movies.update',$pelicula->id], 'method'=>'PUT', 'files'=>true,'class'=>'js-validation-bootstrap form-horizontal']) }}
                        ...
                        <div class='form-group col-md-10'>
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                {{ Form::text('nombre', $pelicula->nombre,['class'=>'form-control', 'placelholder'=>'Ingresa el nombre de la pelicula']) }}
                                </div>
                            </div>
                            <div class="form-group">
                                {{ Form::label('lblDuracion', 'Duración:', ['class'=>'col-md-4 control-label']) }}
                                <div class="col-md-7">
                                {{ Form::text('duracion', $pelicula->duracion,['class'=>'form-control', 'placelholder'=>'Ingresa la duración de la pelicula']) }}    
                                </div>
                            </div>
                            <div class="form-group">
                                {{ Form::label('lblReparto', 'Reparto:', ['class'=>'col-md-4 control-label']) }}
                                <div class="col-md-7">
                                {{ Form::text('reparto', $pelicula->reparto,['class'=>'form-control', 'placelholder'=>'Ingresa la lista de actores de la pelicula']) }}    
                                </div>
                            </div>
                            <div class="form-group">
                                {{ Form::label('lblDirector', 'Director:', ['class'=>'col-md-4 control-label']) }}
                                <div class="col-md-7">
                                {{ Form::text('director', $pelicula->director,['class'=>'form-control', 'placelholder'=>'Ingresa el nombre del director']) }}    
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                {{ Form::select('genero_id', $generos, $pelicula->genero_id, ['id'=>'genero_id', 'class'=>'form-control'])}}    
                                </div>
                            </div>
                            <div class="form-group">
                                {{ Form::label('lblTriller', 'Triller:', ['class'=>'col-md-4 control-label']) }}
                                <div class="col-md-7">
                                {{ Form::text('triller', $pelicula->triller,['class'=>'form-control', 'placelholder'=>'Ej.: www.trillerpelicula.com']) }}    
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                {{ Form::text('fecha', $pelicula->fecha,['class'=>'form-control', 'placelholder'=>'Ej.: 7 de Noviembre de 20XX']) }}    
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                {{ Form::text('resumen', $pelicula->resumen,['class'=>'form-control', 'placelholder'=>'Ingresa una reseña de la pelicula.']) }}    
                                </div>
                            </div>
