        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                ...
                <div class="card-block">
                    ...
                    <form id="form" class="js-validation-bootstrap form-horizontal" action="/roles" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <input class="form-control" type="text" id="rol" name="rol" placeholder="Ingresa el nombre del rol" />
                            </div>
                        </div>
