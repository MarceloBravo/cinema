        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                ...
                <div class="card-block">
                    ...
                    <form id="form" class="js-validation-bootstrap form-horizontal" action="/roles/{{$rol->id}}" method="post">
                        
                        <input type="hidden" name="_method" value="PUT">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">  
                        
                        <div class="form-group">
                            <label class="col-md-4 control-label" for="rol">Nombre del rol <span class="text-orange">*</span></label>
                            <div class="col-md-7">
                                <input class="form-control" type="text" id="rol" name="rol" placeholder="Ingresa tu nombre de usuario" value='{{$rol->rol}}'/>
                            </div>
                        </div>
                    </form>
                    ...
                    <div class="form-group m-b-0 divFormButtons">
                        <div class="col-md-8 col-md-offset-4">
                            ...
                            <button id="btnCancelar" class="btn btn btn-default" type="button" onclick="cancelar('/roles')">Cancelar</button>
                        </div>
                    </div>
