        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                ...
                <div class="card-block">
                    ...
                    {{ Form::model($genero,['id'=>'form','route'=>['generos_musicales.update',$genero->id],'method'=>'PUT','class'=>'js-validation-bootstrap form-horizontal'])}}
                        
                        @include('generos_musicales.form')                    
                        
                    {{ Form::close()}}
                    
                    <form id="formDelete" action="/generos_musicales/{{ $genero->id }}" method="post">
